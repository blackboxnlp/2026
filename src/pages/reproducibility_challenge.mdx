...
Thanks to the generous support of the [National Deep Inference Fabric (NDIF)](https://ndif.us), we will be awarding a **Best Submission Award** to one outstanding submission in the reproducibility challenge that meets the criteria below, as judged by the workshop organizers and NDIF representatives:
