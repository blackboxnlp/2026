...
We will accept direct submissions or ARR commitments through [**OpenReview**](https://openreview.net/group?id=EMNLP/2026/Workshop/BlackboxNLP).
...
## Submission Types
- **Full papers** of up to 8 pages + references. These are papers reporting on completed, original, and unpublished research. Papers shorter than this maximum are also welcome. An optional appendix may appear after the references in the same pdf file. They should report on obtained results rather than intended work. These papers will undergo double-blind peer-review, and should thus be anonymized.
...
Accepted **Full papers** and **Special track papers** will be published in the workshop proceedings of the ACL Anthology, meaning they cannot be published elsewhere.

Accepted submissions of all three types will be presented at the workshop: most as posters, some as oral presentations (determined by the program committee).
...
- **August 27th, 2026** - Notification of acceptance (Main Track and Reproducibility Challenge).
- **August 31st, 2026** - Notification of acceptance (ARR Commitment Track).
